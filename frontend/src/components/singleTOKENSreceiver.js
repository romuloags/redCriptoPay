...
const SingleTOKENSreceiver = ({defaultAccount, tokensEscrow, contactInfo}) => {
                      ...
                      <div className="col pb-5 text-center">
                        <div className="card shadow justify content-center mb-5">
                          <div className="card-body fs-6">  
                            ...
                            className="bi bi-piggy-bank pe-2"></i>Rembolsar</button>}
                            ...
                            overlay={
                            <Tooltip id={`tooltip-${placement}`}>
                            Reembolse el depósito al emisor o abra una disputa si desea que liberen los fondos. 
                            </Tooltip>
                            }
                            >   
                            <i className="bi bi-info-circle ms-2 fs-5 text-danger"></i>
...
export default SingleTOKENSreceiver;