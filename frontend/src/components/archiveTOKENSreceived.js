  ...
  if(loading === true) {
    ...
    <div>   
      ...
      <div className="card shadow my-3" key={tx.id}>
        <Link to={`/historial/ttokensreceptor/${tx.id}`} className="text-decoration-none text-dark">
      ...
      {defaultAccount && transactionsLength >= 1 && <div className=" d-flex justify-content-center">
...
export default ArchiveTOKENSreceived;